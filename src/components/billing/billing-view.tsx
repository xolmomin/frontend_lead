...
const FAQ_IDS = ["faq-1", "faq-2", "faq-3", "faq-4", "faq-5", "faq-6"] as const;
...
function PricingSection() {
  ...
  return (
    <div className="space-y-8">
              ...
              <YbCard
                className={cn(
                  ...
                  current
                    ...
                    : popular && "ring-2 ring-primary dark:ring-primary-400",
                )}
              >
                {current ? (
                  <div className="absolute top-0 right-0">
                    <div className="flex items-center gap-1 bg-success text-white text-xs font-semibold px-3 py-1.5 rounded-bl-xl">
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="mb-4">
                    <h3 className="t-h3 text-foreground mb-1">{plan.name}</h3>
                  </div>
                  <div className="mb-6">
                  ...
                  <YbButton
                    ...
                    loading={subscribe.isPending && confirmPlan?.id === plan.id}
                  >
                    {current
                      ? plan.is_free
      ...
      {/* Custom needs */}
      <YbCard className="bg-gradient-to-r from-primary-50 to-secondary-50 dark:from-slate-800 dark:to-slate-800 border-primary/35">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <h3 className="t-h4 text-foreground mb-1">
      ...
      <div className="mt-12">
        <div className="text-center mb-8">
          <h2 className="text-2xl md:t-h2 text-foreground mb-3">
            {t("faq.title")}
          </h2>
          ...
          {FAQ_IDS.map((id) => {
            ...
            return (
              <YbCard
                key={id}
                padding="none"
                className="overflow-hidden hover:shadow-e2 transition-shadow cursor-pointer"
                onClick={() => setOpenFaq(open ? null : id)}
              >
                <div className="p-4 md:p-5">
                  <div className="flex items-center justify-between gap-4">
                    <h3 className="text-base md:t-h4 text-foreground flex-1">
                      {t(`faq.${id}.question`)}
                    </h3>
          ...
          (() => {
            ...
            return (
              <div className="space-y-4">
                ...
                {current && !free && (
                  <div className="flex gap-3 p-3 rounded-lg bg-warning-muted border border-warning/40">
                ...
                {!free && (
                  <div className="rounded-lg border border-border divide-y divide-border text-sm">
                    ...
                    {needsTopUp && (
                      <div className="flex items-center justify-between p-3 bg-warning-muted">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  {needsTopUp ? (
                    ...
                    >
                      {current ? t("buttons.renew") : t("modal.confirm")}
                    </YbButton>
                  )}
                </div>
              </div>
...
const PAYMENT_STATUS_CLASSES: Record<Payment["status"], string> = {
  confirmed: "bg-success-muted text-success dark:text-success",
  rejected: "bg-destructive-muted text-destructive dark:text-destructive",
      ...
      },
      {
        ...
        accessor: (row) =>
          row.receipt_filename ? (
            <span className="text-muted-foreground truncate max-w-48 inline-block align-bottom">
              {row.receipt_filename}
            </span>
          ) : (
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <YbCard>
          ...
          <div className="mt-4 p-4 rounded-xl bg-warning-muted border border-warning/40">
        ...
        {/* Top up */}
        <YbCard>
          <h3 className="t-h4 text-foreground mb-4">{t("balance.topUp")}</h3>
              ...
              >
                ...
                >
                  <Icon
                    className={cn(
                      "w-5 h-5",
                      method === key ? "text-primary" : "text-muted-foreground",
                    )}
                  />
                </div>
                <span
                  className={cn(
                    "text-sm font-medium",
                    method === key ? "text-primary" : "text-foreground/80",
                  )}
                >
                  {label}
                </span>
      ...
      {/* Payment history */}
      <YbCard>
        <h3 className="t-h4 text-foreground mb-4">
